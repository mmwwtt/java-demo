...
(
    ...
    up_shadow_len          DOUBLE      NOT NULL COMMENT '上影线长度',
    up_shadow_pert         DOUBLE      NOT NULL COMMENT '上影线站总长的百分比',
    low_shadow_len         DOUBLE      NOT NULL COMMENT '下影线长度',
    low_shadow_pert        DOUBLE      NOT NULL COMMENT '下影线站总长的百分比',
    entity_len             DOUBLE      NOT NULL COMMENT '实体长度',
    entity_pert            DOUBLE      NOT NULL COMMENT '实体占总长的百分比',
    all_len                DOUBLE      NOT NULL COMMENT '总长',
    five_day_line          DOUBLE      NOT NULL COMMENT '5日线',
    ten_day_line           DOUBLE      NOT NULL COMMENT '10日线',
    twenty_day_line        DOUBLE      NOT NULL COMMENT '20日线',
    sixty_day_line         DOUBLE      NOT NULL COMMENT '60日线',
    pert_division_quentity DOUBLE      NOT NULL COMMENT '涨跌成交比',
    is_up                  BOOLEAN     NOT NULL COMMENT '是否为阳线(收盘价高于开盘价，  可能是-9  -> -1  也是阳线)',
    is_down                BOOLEAN     NOT NULL COMMENT '是否为阴线',
    is_balance             BOOLEAN     NOT NULL COMMENT '开盘价是否等于收盘价',
    is_ten_star            BOOLEAN     NOT NULL COMMENT '是否为十字星'
) COMMENT '股票详情表';
