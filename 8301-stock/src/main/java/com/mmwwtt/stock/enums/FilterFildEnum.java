...
public enum FilterFildEnum implements BaseEnum {
    ...
    RISE5_MAX_MIDDLE_03("rise5MaxMiddle03", "最大五日涨幅中位数 l1域值0.03",
            ...
            (StrategyTmp tmp) -> {
                ...
                if (lessThan(tmp.getPert(), multiply(tmp.getParentPert(), 1.001))
                        ...
                        || (level == 5 && (lessThan(tmp.getPert(), 0.085) || tmp.getDateCnt() < 55 || tmp.getRise5MinMiddle() < -0.045))
                        || (level == 6 && (lessThan(tmp.getPert(), 0.09) || tmp.getDateCnt() < 55 || tmp.getRise5MinMiddle() < -0.045))
                        || (level == 7 && (lessThan(tmp.getPert(), 0.10) || tmp.getDateCnt() < 50 || tmp.getRise5MinMiddle() < -0.04))
                        || (level == 8 && (lessThan(tmp.getPert(), 0.11) || tmp.getDateCnt() < 50 || tmp.getRise5MinMiddle() < -0.04))
                        || (level == 9 && (lessThan(tmp.getPert(), 0.12) || tmp.getDateCnt() < 45 || tmp.getRise5MinMiddle() < -0.035))
    ...
    RISE5_MAX_MIDDLE_025("rise5MaxMiddle025", "最大五日涨幅中位数 l1域值0.025",
            ...
            (StrategyTmp tmp) -> {
                int level = tmp.getStrategyCodeSet().size();
                if (lessThan(tmp.getPert(), multiply(tmp.getParentPert(), 1.001))
                        || (level == 2 && (lessThan(tmp.getPert(), 0.065) || tmp.getDateCnt() < 60 || tmp.getRise5MinMiddle() < -0.045))
                        || (level == 3 && (lessThan(tmp.getPert(), 0.075) || tmp.getDateCnt() < 60 || tmp.getRise5MinMiddle() < -0.04))
                        || (level == 4 && (lessThan(tmp.getPert(), 0.08) || tmp.getDateCnt() < 55 || tmp.getRise5MinMiddle() < -0.04))
                        || (level == 5 && (lessThan(tmp.getPert(), 0.085) || tmp.getDateCnt() < 55 || tmp.getRise5MinMiddle() < -0.04))
                        || (level == 6 && (lessThan(tmp.getPert(), 0.09) || tmp.getDateCnt() < 55 || tmp.getRise5MinMiddle() < -0.04))
                        || (level == 7 && (lessThan(tmp.getPert(), 0.10) || tmp.getDateCnt() < 50 || tmp.getRise5MinMiddle() < -0.035))
                        || (level == 8 && (lessThan(tmp.getPert(), 0.11) || tmp.getDateCnt() < 50 || tmp.getRise5MinMiddle() < -0.035))
                        || (level == 9 && (lessThan(tmp.getPert(), 0.12) || tmp.getDateCnt() < 45 || tmp.getRise5MinMiddle() < -0.035))
                        || (level == 10 && (lessThan(tmp.getPert(), 0.13) || tmp.getDateCnt() < 45 || tmp.getRise5MinMiddle() < -0.035))
                        || (level == 11 && (lessThan(tmp.getPert(), 0.135) || tmp.getDateCnt() < 45 || tmp.getRise5MinMiddle() < -0.035))
                        || (level == 12 && (lessThan(tmp.getPert(), 0.14) || tmp.getDateCnt() < 40 || tmp.getRise5MinMiddle() < -0.035))
