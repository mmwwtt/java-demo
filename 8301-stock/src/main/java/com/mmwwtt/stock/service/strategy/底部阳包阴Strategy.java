...
public class 底部阳包阴Strategy {
    static {
        ...
        StockCalcService.STRATEGY_LIST.addAll(Arrays.asList(
                ...
                new StockStrategy("底部阳包阴 放量 0.5<下影线", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴 放量 0.4<下影线<0.5", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴(看涨吞没) 放量1.5  60日底部40", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                            && moreThan(t0.getDealQuantity(), multiply(t0.getFiveDayDealQuantity(), "1.5"))
                            && moreThan(t0.getLowShadowPert(), "0.4")
                            && lessThan(t0.getPosition60(), "0.4");
                }),


                new StockStrategy("底部阳包阴 放量 0.5<下影线 60日底部40", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴(看涨吞没) 放量1.5  40日底部40", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴 放量 0.5<下影线 40日底部40", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴(看涨吞没) 放量1.5  40日底部30", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
                ...
                new StockStrategy("底部阳包阴 放量 0.5<下影线 40日底部30", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return t1.getIsDown() && t0.getIsUp()
                            && lessThan(t0.getStartPrice(), t1.getEndPrice())
                            && moreThan(t0.getEndPrice(), t1.getStartPrice())
