...
public class 一般Strategy {
    static {
        StockCalcService.STRATEGY_LIST.addAll(Arrays.asList(
                ...
                new StockStrategy("当天是红", StockDetail::getIsUp),


                new StockStrategy("当天是绿", StockDetail::getIsDown),


                new StockStrategy("比前一天放量", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return moreThan(t0.getDealQuantity(), t1.getDealQuantity());
                }),

                new StockStrategy("放量红", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                ...
                new StockStrategy("放量绿", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    return moreThan(t0.getDealQuantity(), t0.getT1().getDealQuantity())
                            && t0.getIsGreen()
                            && t1.getIsRed();
                ...
                new StockStrategy("缩量红", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                ...
                new StockStrategy("缩量绿", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                ...
                new StockStrategy("十字星", StockDetail::getIsTenStar),

                new StockStrategy("二连红", (StockDetail t0) -> {
                ...
                new StockStrategy("连续2天放量，且当天是红", (StockDetail t0) -> {
                    return moreThan(t0.getDealQuantity(), t0.getT1().getDealQuantity())
                ...
                new StockStrategy("涨幅成交比扩大 缩量 二连红", (StockDetail t0) -> {
                ...
                new StockStrategy("涨幅成交比扩大 缩量红", (StockDetail t0) -> {
                    return moreThan(t0.getPertDivisionQuantity(), t0.getT1().getPertDivisionQuantity())
                            && lessThan(t0.getDealQuantity(), t0.getT1().getDealQuantity())
                            && t0.getIsUp();
                }),
                ...
                new StockStrategy("涨幅成交比扩大 缩量", (StockDetail t0) -> {
                    return moreThan(t0.getPertDivisionQuantity(), t0.getT1().getPertDivisionQuantity())
                            && lessThan(t0.getDealQuantity(), t0.getT1().getDealQuantity());
                }),


                new StockStrategy("涨幅成交比扩大", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                ...
                new StockStrategy("双针探底_简化版", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                ...
                new StockStrategy("放量突破20日最高", (StockDetail t0) -> {
                    // 1. 收盘突破 20 日最高
                ...
                new StockStrategy("平底突破", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                ...
                new StockStrategy("早晨之星(启明星)", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                ...
                new StockStrategy("缩量3连阴后首阳", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                    StockDetail t3 = t0.getT3();
                    // 1. 三连阴
                ...
                new StockStrategy("前一天是 缩量十字星 次日放量阳", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                ...
                new StockStrategy("缩量回踩10日线后放量", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                    StockDetail t3 = t0.getT3();
                    /* 1. 连续 2-3 日缩量（量逐日递减） */
                ...
                new StockStrategy("缩量上涨 2天 且macd<-1", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                    StockDetail t3 = t0.getT3();
                ...
                new StockStrategy("缩量上涨 3天", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                    StockDetail t3 = t0.getT3();
                ...
                new StockStrategy("WR 低于 -80， 且在上升", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                ...
                new StockStrategy("阴线，但最低价 比前一天开盘价高", (StockDetail t0) -> {
                    StockDetail t1 = t0.getT1();
                    StockDetail t2 = t0.getT2();
                    StockDetail t3 = t0.getT3();
