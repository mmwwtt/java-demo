...
public class JTest {
    ...
    private List<StrategyEnum> buildCandlestickStrategyEnums() {
        ...
        // ========== 单根K线形态 ==========
        list.add(new StrategyEnum("C01", "十字星_Doji", StockDetail::getIsTenStar));

        list.add(new StrategyEnum("C02", "锤子线_Hammer", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C03", "倒锤子_InvertedHammer", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C04", "上吊线_HangingMan", (StockDetail d) -> {
            if (d.getLowShadowLen() == null || d.getEntityLen() == null || d.getUpShadowLen() == null) return false;
            return moreThan(d.getLowShadowLen(), multiply(d.getEntityLen(), "2"))
                    && lessThan(d.getUpShadowLen(), "0.02")
        ...
        list.add(new StrategyEnum("C05", "射击之星_ShootingStar", (StockDetail d) -> {
            if (d.getUpShadowLen() == null || d.getEntityLen() == null || d.getLowShadowLen() == null) return false;
            return moreThan(d.getUpShadowLen(), multiply(d.getEntityLen(), "2"))
                    && lessThan(d.getLowShadowLen(), "0.02")
                    && Boolean.TRUE.equals(d.getIsGreen());
        ...
        list.add(new StrategyEnum("C06", "纺锤线_SpinningTop", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C07", "长实体_Marubozu", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C08", "蜻蜓十字_DragonflyDoji", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C09", "墓碑十字_GravestoneDoji", (StockDetail d) -> {
        ...
        // ========== 双K线形态 ==========
        list.add(new StrategyEnum("C10", "看涨吞没_BullishEngulfing", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C11", "看跌吞没_BearishEngulfing", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C12", "看涨孕线_BullishHarami", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C13", "看跌孕线_BearishHarami", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C14", "刺透形态_PiercingLine", (StockDetail d) -> {
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C15", "乌云盖顶_DarkCloudCover", (StockDetail d) -> {
            StockDetail t1 = d.getT1();
            if (t1 == null || t1.getStartPrice() == null || t1.getEndPrice() == null) return false;
            BigDecimal sum = add(t1.getStartPrice(), t1.getEndPrice());
            if (sum == null) return false;
        ...
        list.add(new StrategyEnum("C16", "双顶_TweezerTops", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C17", "双底_TweezerBottoms", (StockDetail d) -> {
        ...
        // ========== 三K线形态 ==========
        list.add(new StrategyEnum("C18", "启明星_MorningStar", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C19", "黄昏星_EveningStar", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
            BigDecimal t2Mid = add(t2.getStartPrice(), t2.getEndPrice());
            if (t2Mid == null) return false;
        ...
        list.add(new StrategyEnum("C20", "红三兵_ThreeWhiteSoldiers", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
        ...
        list.add(new StrategyEnum("C21", "三只乌鸦_ThreeBlackCrows", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
        ...
        list.add(new StrategyEnum("C22", "向上三法_ThreeInsideUp", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C23", "向下三法_ThreeInsideDown", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2(), t3 = d.getT3();
        ...
        list.add(new StrategyEnum("C24", "上升三法_RisingThreeMethods", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C25", "下降三法_FallingThreeMethods", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null || d.getT4() == null) return false;
            StockDetail t4 = d.getT4();
        ...
        // ========== 多K线组合 ==========
        list.add(new StrategyEnum("C26", "二连红", (StockDetail d) -> d.getT1() != null && Boolean.TRUE.equals(d.getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed())));
        list.add(new StrategyEnum("C27", "三连红", (StockDetail d) -> d.getT1() != null && d.getT2() != null
                && Boolean.TRUE.equals(d.getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed()) && Boolean.TRUE.equals(d.getT2().getIsRed())));
        list.add(new StrategyEnum("C28", "四连红", (StockDetail d) -> d.getT1() != null && d.getT2() != null && d.getT3() != null
        ...
        list.add(new StrategyEnum("C29", "五连红", (StockDetail d) -> d.getT1() != null && d.getT2() != null && d.getT3() != null && d.getT4() != null
                && Boolean.TRUE.equals(d.getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed()) && Boolean.TRUE.equals(d.getT2().getIsRed())
                && Boolean.TRUE.equals(d.getT3().getIsRed()) && Boolean.TRUE.equals(d.getT4().getIsRed())));

        list.add(new StrategyEnum("C30", "二连阴", (StockDetail d) -> d.getT1() != null && Boolean.TRUE.equals(d.getIsGreen()) && Boolean.TRUE.equals(d.getT1().getIsGreen())));
        list.add(new StrategyEnum("C31", "三连阴", (StockDetail d) -> d.getT1() != null && d.getT2() != null
                && Boolean.TRUE.equals(d.getIsGreen()) && Boolean.TRUE.equals(d.getT1().getIsGreen()) && Boolean.TRUE.equals(d.getT2().getIsGreen())));
        list.add(new StrategyEnum("C32", "四连阴", (StockDetail d) -> d.getT1() != null && d.getT2() != null && d.getT3() != null
        ...
        list.add(new StrategyEnum("C33", "五连阴", (StockDetail d) -> d.getT1() != null && d.getT2() != null && d.getT3() != null && d.getT4() != null
                && Boolean.TRUE.equals(d.getIsGreen()) && Boolean.TRUE.equals(d.getT1().getIsGreen()) && Boolean.TRUE.equals(d.getT2().getIsGreen())
                && Boolean.TRUE.equals(d.getT3().getIsGreen()) && Boolean.TRUE.equals(d.getT4().getIsGreen())));

        // ========== 补充单根K线 ==========
        list.add(new StrategyEnum("C34", "长腿十字_LongLeggedDoji", (StockDetail d) -> {
            if (d.getUpShadowLen() == null || d.getLowShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsTenStar())
                    && moreThan(d.getUpShadowLen(), "0.03")
                    && moreThan(d.getLowShadowLen(), "0.03");
        }));
        list.add(new StrategyEnum("C35", "大阳线_BigWhiteCandle", (StockDetail d) -> {
            if (d.getEntityPert() == null || d.getUpShadowPert() == null || d.getLowShadowPert() == null) return false;
        ...
        list.add(new StrategyEnum("C36", "大阴线_BigBlackCandle", (StockDetail d) -> {
            if (d.getEntityPert() == null || d.getUpShadowPert() == null || d.getLowShadowPert() == null) return false;
        ...
        // ========== 补充双K线 ==========
        list.add(new StrategyEnum("C44", "看涨孕线十字_BullishHaramiCross", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C45", "看跌孕线十字_BearishHaramiCross", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C46", "上升跳空_RisingWindow", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            return moreThan(d.getLowPrice(), d.getT1().getHighPrice());
        }));
        list.add(new StrategyEnum("C47", "下降跳空_FallingWindow", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            return lessThan(d.getHighPrice(), d.getT1().getLowPrice());
        }));
        list.add(new StrategyEnum("C48", "反击线看涨_CounterattackBullish", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C49", "反击线看跌_CounterattackBearish", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
            return Boolean.TRUE.equals(t1.getIsRed()) && Boolean.TRUE.equals(d.getIsGreen())
                    && moreThan(d.getStartPrice(), t1.getEndPrice())
        ...
        // ========== 补充三K线 ==========
        list.add(new StrategyEnum("C50", "启明十字星_MorningDojiStar", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
            BigDecimal t2Mid = add(t2.getStartPrice(), t2.getEndPrice());
            if (t2Mid == null) return false;
        ...
        list.add(new StrategyEnum("C51", "黄昏十字星_EveningDojiStar", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
            BigDecimal t2Mid = add(t2.getStartPrice(), t2.getEndPrice());
            if (t2Mid == null) return false;
        ...
        list.add(new StrategyEnum("C52", "十字星形态_DojiStar", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            return Boolean.TRUE.equals(d.getIsTenStar())
        ...
        list.add(new StrategyEnum("C58", "下降跳空并列阴_DownsideTasuki", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
        ...
        // ========== 颈线/刺透变体 ==========
        list.add(new StrategyEnum("C59", "颈线形态_OnNeck", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C60", "刺入形态_InNeck", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C61", "刺透变体_Thrusting", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        // ========== 踢脚形态 ==========
        list.add(new StrategyEnum("C62", "看涨踢脚_BullishKicking", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C63", "看跌踢脚_BearishKicking", (StockDetail d) -> {
            if (d.getT1() == null || d.getEntityPert() == null || d.getT1().getEntityPert() == null) return false;
            StockDetail t1 = d.getT1();
            return Boolean.TRUE.equals(t1.getIsRed()) && Boolean.TRUE.equals(d.getIsGreen())
        ...
        // ========== 分离线/相遇线 ==========
        list.add(new StrategyEnum("C64", "看涨分离线_BullishSeparating", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C65", "看跌分离线_BearishSeparating", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
            StockDetail t1 = d.getT1();
            BigDecimal diff = subtract(d.getStartPrice(), t1.getStartPrice());
            return Boolean.TRUE.equals(t1.getIsRed()) && Boolean.TRUE.equals(d.getIsGreen())
        ...
        list.add(new StrategyEnum("C66", "看涨相遇线_BullishMeeting", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C67", "看跌相遇线_BearishMeeting", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
            StockDetail t1 = d.getT1();
            BigDecimal diff = subtract(d.getEndPrice(), t1.getEndPrice());
            return Boolean.TRUE.equals(t1.getIsRed()) && Boolean.TRUE.equals(d.getIsGreen())
        ...
        // ========== 三K线补充 ==========
        list.add(new StrategyEnum("C68", "两只乌鸦_TwoCrows", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
            return Boolean.TRUE.equals(t2.getIsRed())
        ...
        list.add(new StrategyEnum("C69", "向上跳空两鸦_UpsideGapTwoCrows", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C70", "外向上三法_ThreeOutsideUp", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C71", "外向下三法_ThreeOutsideDown", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C72", "南方三星_ThreeStarsSouth", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C73", "独特三川底_UniqueThreeRiver", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C74", "弃婴看涨_AbandonedBabyBullish", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C75", "弃婴看跌_AbandonedBabyBearish", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        // ========== 四/五K线 ==========
        list.add(new StrategyEnum("C76", "看涨三线打击_BullishThreeLineStrike", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null) return false;
        ...
        list.add(new StrategyEnum("C77", "看跌三线打击_BearishThreeLineStrike", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null) return false;
        ...
        list.add(new StrategyEnum("C78", "梯底_LadderBottom", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null || d.getT4() == null) return false;
        ...
        list.add(new StrategyEnum("C79", "藏婴吞没_ConcealingBabySwallow", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2(), t3 = d.getT3();
        ...
        list.add(new StrategyEnum("C83", "纺锤阴线_BlackSpinningTop", (StockDetail d) -> {
            if (d.getEntityPert() == null || d.getUpShadowLen() == null || d.getLowShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsGreen()) && isInRangeNotEquals(d.getEntityPert(), "0.1", "0.4")
                    && moreThan(d.getUpShadowLen(), "0.02") && moreThan(d.getLowShadowLen(), "0.02");
        }));
        list.add(new StrategyEnum("C84", "两阴跳空_TwoBlackGapping", (StockDetail d) -> {
            if (d.getT1() == null) return false;
        ...
        list.add(new StrategyEnum("C85", "家鸽_HomingPigeon", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        // ========== 看涨形态补充（会上涨信号） ==========
        list.add(new StrategyEnum("C86", "阳线锤子_看涨Hammer", (StockDetail d) -> {
            if (d.getLowShadowLen() == null || d.getEntityLen() == null || d.getUpShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed())
        ...
        list.add(new StrategyEnum("C87", "阳线倒锤子_看涨InvertedHammer", (StockDetail d) -> {
            if (d.getUpShadowLen() == null || d.getEntityLen() == null || d.getLowShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed())
        ...
        list.add(new StrategyEnum("C88", "探底线_TakuriLine", (StockDetail d) -> {
            if (d.getLowShadowLen() == null || d.getEntityLen() == null || d.getUpShadowLen() == null) return false;
            return moreThan(d.getLowShadowLen(), "0.05")
                    && lessThan(d.getUpShadowLen(), "0.01")
                    && (d.getEntityLen() == null || lessThan(d.getEntityLen(), "0.02"));
        }));
        list.add(new StrategyEnum("C89", "光头光脚阳线_BullishBeltHold", (StockDetail d) -> {
            if (d.getLowShadowLen() == null || d.getUpShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed())
                    && lessThan(d.getLowShadowLen(), "0.005")
                    && lessThan(d.getUpShadowLen(), "0.005")
        ...
        list.add(new StrategyEnum("C90", "强势阳线_BullishStrongLine", (StockDetail d) -> {
            if (d.getEntityPert() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed())
                    && moreThan(d.getEntityPert(), "0.6")
                    && moreThan(d.getEndPrice(), d.getStartPrice());
        }));
        list.add(new StrategyEnum("C91", "最后吞没底_LastEngulfingBottom", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
        ...
        list.add(new StrategyEnum("C92", "并列阳线看涨_BullishSideBySide", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            return moreThan(d.getT1().getLowPrice(), d.getT2().getHighPrice())
                    && Boolean.TRUE.equals(d.getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed())
                    && moreThan(d.getStartPrice(), d.getT1().getStartPrice())
        ...
        list.add(new StrategyEnum("C93", "向上反转_TurnUp", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
            return Boolean.TRUE.equals(t1.getIsGreen()) && Boolean.TRUE.equals(d.getIsRed())
                    && lessThan(d.getStartPrice(), t1.getEndPrice())
        ...
        list.add(new StrategyEnum("C94", "跳空高开十字_GappingUpDoji", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            return Boolean.TRUE.equals(d.getIsTenStar())
                    && moreThan(d.getLowPrice(), d.getT1().getHighPrice());
        }));
        list.add(new StrategyEnum("C95", "低位十字_SouthernDoji", (StockDetail d) -> {
            if (d.getT1() == null || d.getPosition20() == null) return false;
            return Boolean.TRUE.equals(d.getIsTenStar())
                    && lessThan(d.getPosition20(), "0.3");
        }));
        list.add(new StrategyEnum("C96", "向上跳空三法_UpsideGapThreeMethods", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null || d.getT4() == null) return false;
        ...
        list.add(new StrategyEnum("C97", "铺垫形态_MatHold", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null || d.getT4() == null) return false;
            StockDetail t4 = d.getT4();
            return Boolean.TRUE.equals(t4.getIsRed())
                    && Boolean.TRUE.equals(d.getT3().getIsGreen()) && Boolean.TRUE.equals(d.getT2().getIsGreen()) && Boolean.TRUE.equals(d.getT1().getIsGreen())
        ...
        list.add(new StrategyEnum("C98", "三明治看涨_StickSandwich", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C99", "突破形态_BullishBreakaway", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null || d.getT3() == null || d.getT4() == null) return false;
            StockDetail t4 = d.getT4();
            return Boolean.TRUE.equals(t4.getIsGreen())
                    && Boolean.TRUE.equals(d.getT3().getIsRed()) && Boolean.TRUE.equals(d.getT2().getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed())
        ...
        list.add(new StrategyEnum("C100", "蜻蜓十字_看涨DragonflyDoji", (StockDetail d) -> {
            if (d.getLowShadowLen() == null || d.getUpShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsTenStar())
                    && moreThan(d.getLowShadowLen(), "0.03")
                    && lessThan(d.getUpShadowLen(), "0.005");
        }));
        list.add(new StrategyEnum("C101", "看涨吞没加强_BullishEngulfingStrong", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C102", "红三兵加强_ThreeSoldiersStrong", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed()) && Boolean.TRUE.equals(d.getT2().getIsRed())
                    && moreThan(d.getEndPrice(), d.getT1().getEndPrice())
                    && moreThan(d.getT1().getEndPrice(), d.getT2().getEndPrice())
        ...
        list.add(new StrategyEnum("C103", "刺透加强_PiercingStrong", (StockDetail d) -> {
            StockDetail t1 = d.getT1();
            if (t1 == null || t1.getStartPrice() == null || t1.getEndPrice() == null) return false;
            BigDecimal mid = add(t1.getStartPrice(), t1.getEndPrice());
            if (mid == null) return false;
        ...
        list.add(new StrategyEnum("C104", "启明星加强_MorningStarStrong", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
            BigDecimal t2Mid = add(t2.getStartPrice(), t2.getEndPrice());
            if (t2Mid == null) return false;
        ...
        // ========== 偏看涨形态 第二批 ==========
        list.add(new StrategyEnum("C105", "跳空低开十字_GappingDownDoji", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            return Boolean.TRUE.equals(d.getIsTenStar()) && lessThan(d.getHighPrice(), d.getT1().getLowPrice());
        }));
        list.add(new StrategyEnum("C106", "收盘光头阳线_ClosingWhiteMarubozu", (StockDetail d) -> {
            if (d.getUpShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed()) && lessThan(d.getUpShadowLen(), "0.005") && moreThan(d.getEntityLen(), "0.02");
        }));
        list.add(new StrategyEnum("C107", "开盘光头阳线_OpeningWhiteMarubozu", (StockDetail d) -> {
            if (d.getLowShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed()) && lessThan(d.getLowShadowLen(), "0.005") && moreThan(d.getEntityLen(), "0.02");
        }));
        list.add(new StrategyEnum("C108", "长白蜡烛_LongWhiteCandle", (StockDetail d) -> {
            if (d.getEntityPert() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed()) && moreThan(d.getEntityPert(), "0.65");
        }));
        list.add(new StrategyEnum("C109", "纺锤阳线看涨_BullishSpinningTop", (StockDetail d) -> {
            if (d.getEntityPert() == null || d.getUpShadowLen() == null || d.getLowShadowLen() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed()) && isInRangeNotEquals(d.getEntityPert(), "0.1", "0.4")
                    && moreThan(d.getUpShadowLen(), "0.02") && moreThan(d.getLowShadowLen(), "0.02");
        }));
        list.add(new StrategyEnum("C110", "下降鹰_DescendingHawk", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            StockDetail t1 = d.getT1(), t2 = d.getT2();
            return Boolean.TRUE.equals(t2.getIsGreen()) && Boolean.TRUE.equals(t1.getIsGreen()) && Boolean.TRUE.equals(d.getIsRed())
        ...
        list.add(new StrategyEnum("C111", "迟疑形态_Deliberation", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            return Boolean.TRUE.equals(d.getIsRed()) && Boolean.TRUE.equals(d.getT1().getIsRed()) && Boolean.TRUE.equals(d.getT2().getIsRed())
        ...
        list.add(new StrategyEnum("C112", "三星看涨_BullishTriStar", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
        ...
        list.add(new StrategyEnum("C113", "看涨孕线加强_BullishHaramiStrong", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
            return Boolean.TRUE.equals(t1.getIsGreen()) && Boolean.TRUE.equals(d.getIsRed())
        ...
        list.add(new StrategyEnum("C114", "双底看涨_TweezerBottomBullish", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
        ...
        list.add(new StrategyEnum("C115", "颈线看涨_OnNeckBullish", (StockDetail d) -> {
            if (d.getT1() == null || d.getLastPrice() == null) return false;
            StockDetail t1 = d.getT1();
            BigDecimal diff = subtract(d.getEndPrice(), t1.getLowPrice());
            return Boolean.TRUE.equals(t1.getIsGreen()) && Boolean.TRUE.equals(d.getIsRed())
        ...
        list.add(new StrategyEnum("C116", "刺入看涨_InNeckBullish", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
            BigDecimal bodyLen = subtract(t1.getStartPrice(), t1.getEndPrice());
            BigDecimal closeAbove = subtract(d.getEndPrice(), t1.getEndPrice());
        ...
        list.add(new StrategyEnum("C117", "六连红", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C118", "七连红", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C119", "上升窗口支撑_RisingWindowSupport", (StockDetail d) -> {
            if (d.getT1() == null || d.getT2() == null) return false;
            return moreThan(d.getT1().getLowPrice(), d.getT2().getHighPrice())
                    && Boolean.TRUE.equals(d.getIsRed())
                    && moreThan(d.getLowPrice(), d.getT1().getLowPrice());
        }));
        list.add(new StrategyEnum("C120", "阳包阴缩量", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C121", "低位锤子_LowPositionHammer", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C122", "低位吞没_LowPositionEngulfing", (StockDetail d) -> {
            if (d.getT1() == null || d.getPosition20() == null) return false;
            StockDetail t1 = d.getT1();
        ...
        list.add(new StrategyEnum("C123", "超卖区蜻蜓十字_WROversoldDragonfly", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C124", "超卖区锤子_WROversoldHammer", (StockDetail d) -> {
        ...
        list.add(new StrategyEnum("C125", "看涨孕线十字加强_BullishHaramiCrossStrong", (StockDetail d) -> {
            if (d.getT1() == null) return false;
            StockDetail t1 = d.getT1();
            return Boolean.TRUE.equals(t1.getIsGreen()) && Boolean.TRUE.equals(d.getIsTenStar())
