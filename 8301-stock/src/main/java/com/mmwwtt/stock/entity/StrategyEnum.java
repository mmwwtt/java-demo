...
public class StrategyEnum {
    ...
    static {
        baseStrategyList.addAll(Arrays.asList(
                ...
                new StrategyEnum("20031", "macd_负2_负1", (StockDetail t0) -> isInRange(t0.getMacd(), -2, -1)),
                new StrategyEnum("20032", "macd_负1_0", (StockDetail t0) -> isInRange(t0.getMacd(), -1, 0)),
                new StrategyEnum("20033", "macd_0_1", (StockDetail t0) -> isInRange(t0.getMacd(), 0, 1)),
                new StrategyEnum("20034", "macd_1_2", (StockDetail t0) -> isInRange(t0.getMacd(), 1, 2)),
                new StrategyEnum("20035", "macd_2_5", (StockDetail t0) -> isInRange(t0.getMacd(), 2, 5)),
                ...
                new StrategyEnum("21002", "下影线占比10_40", (StockDetail t0) -> isInRange(t0.getLowShadowPert(), 0.1, 0.4)),
                new StrategyEnum("21004", "下影线占比40_70", (StockDetail t0) -> isInRange(t0.getLowShadowPert(), 0.4, 0.7)),
                new StrategyEnum("21006", "下影线占比70_100", (StockDetail t0) -> isInRange(t0.getLowShadowPert(), 0.7, 1.0)),

                new StrategyEnum("21022", "上影线占比10_40", (StockDetail t0) -> isInRange(t0.getUpShadowPert(), 0.1, 0.4)),
                new StrategyEnum("21024", "上影线占比40_70", (StockDetail t0) -> isInRange(t0.getUpShadowPert(), 0.4, 0.7)),
                new StrategyEnum("21028", "上影线占比70_100", (StockDetail t0) -> isInRange(t0.getUpShadowPert(), 0.7, 1.0)),

                new StrategyEnum("21031", "上影线长度_00_03", (StockDetail t0) -> isInRange(t0.getUpShadowLen(), 0.00, 0.03)),
                new StrategyEnum("21032", "上影线长度_03_06", (StockDetail t0) -> isInRange(t0.getUpShadowLen(), 0.03, 0.06)),
                new StrategyEnum("21034", "上影线长度_06_10", (StockDetail t0) -> isInRange(t0.getUpShadowLen(), 0.06, 0.10)),

                new StrategyEnum("21040", "总长度_00_03", (StockDetail t0) -> isInRange(t0.getAllLen(), 0, 0.03)),
                new StrategyEnum("21042", "总长度_03_06", (StockDetail t0) -> isInRange(t0.getAllLen(), 0.03, 0.06)),
                new StrategyEnum("21044", "总长度_06_09", (StockDetail t0) -> isInRange(t0.getAllLen(), 0.06, 0.09)),
                new StrategyEnum("21046", "总长度_09_12", (StockDetail t0) -> isInRange(t0.getAllLen(), 0.09, 0.12)),
                new StrategyEnum("21048", "总长度_12_16", (StockDetail t0) -> isInRange(t0.getAllLen(), 0.12, 0.16)),


                new StrategyEnum("21060", "区间60_00_30", (StockDetail t0) -> isInRange(t0.getPosition60(), 0, 0.3)),
                new StrategyEnum("21062", "区间60_30_60", (StockDetail t0) -> isInRange(t0.getPosition60(), 0.3, 0.6)),
                new StrategyEnum("21064", "区间60_60_90", (StockDetail t0) -> isInRange(t0.getPosition60(), 0.6, 0.9)),
                new StrategyEnum("21066", "区间60_90_100", (StockDetail t0) -> isInRange(t0.getPosition60(), 0.9, 1.0)),

                new StrategyEnum("21070", "区间40_00_30", (StockDetail t0) -> isInRange(t0.getPosition40(), 0, 0.3)),
                new StrategyEnum("21072", "区间40_30_60", (StockDetail t0) -> isInRange(t0.getPosition40(), 0.3, 0.6)),
                new StrategyEnum("21074", "区间40_60_90", (StockDetail t0) -> isInRange(t0.getPosition40(), 0.6, 0.9)),
                new StrategyEnum("21076", "区间40_90_100", (StockDetail t0) -> isInRange(t0.getPosition40(), 0.9, 1.0)),

                new StrategyEnum("21080", "区间20_00_30", (StockDetail t0) -> isInRange(t0.getPosition20(), 0, 0.3)),
                new StrategyEnum("21082", "区间20_30_60", (StockDetail t0) -> isInRange(t0.getPosition20(), 0.3, 0.6)),
                new StrategyEnum("21084", "区间20_60_90", (StockDetail t0) -> isInRange(t0.getPosition20(), 0.6, 0.9)),
                new StrategyEnum("21086", "区间20_90_100", (StockDetail t0) -> isInRange(t0.getPosition20(), 0.9, 1.0)),
                ...
                new StrategyEnum("21100", "下影线长度_00_03", (StockDetail t0) -> isInRange(t0.getLowShadowLen(), 0, 0.03)),
                new StrategyEnum("21102", "下影线长度_03_06", (StockDetail t0) -> isInRange(t0.getLowShadowLen(), 0.03, 0.06)),
                new StrategyEnum("21104", "下影线长度_06_12", (StockDetail t0) -> isInRange(t0.getLowShadowLen(), 0.06, 0.12)),
                new StrategyEnum("21107", "下影线长度大于_12", (StockDetail t0) -> moreThan(t0.getLowShadowLen(), 0.12)),


                new StrategyEnum("21120", "比前一天缩量_00_30", (StockDetail t0) -> isInRange(t0.getDealQuantity(), 0,
                        multiply(t0.getT1().getDealQuantity(), 0.3))),
                new StrategyEnum("21122", "比前一天缩量_30_60", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                        multiply(t0.getT1().getDealQuantity(), 0.3), multiply(t0.getT1().getDealQuantity(), 0.6))),
                new StrategyEnum("21124", "比前一天缩量_60_90", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                        multiply(t0.getT1().getDealQuantity(), 0.6), multiply(t0.getT1().getDealQuantity(), 0.9))),


                new StrategyEnum("21130", "比前一天放量_00_30", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                        multiply(t0.getT1().getDealQuantity(), 1), multiply(t0.getT1().getDealQuantity(), 1.3))),
                new StrategyEnum("21132", "比前一天放量_30_60", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                        multiply(t0.getT1().getDealQuantity(), 1.3), multiply(t0.getT1().getDealQuantity(), 1.6))),
                new StrategyEnum("21134", "比前一天放量_60_90", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                        multiply(t0.getT1().getDealQuantity(), 1.6), multiply(t0.getT1().getDealQuantity(), 1.9))),
                new StrategyEnum("21136", "比前一天放量_90_120", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                        multiply(t0.getT1().getDealQuantity(), 1.9), multiply(t0.getT1().getDealQuantity(), 2.2))),
                new StrategyEnum("21138", "比前一天放量_120_150", (StockDetail t0) -> isInRange(t0.getDealQuantity(),
                ...
                new StrategyEnum("21150", "区间10_00_30", (StockDetail t0) -> isInRange(t0.getPosition10(), 0, 0.3)),
                new StrategyEnum("21152", "区间10_30_60", (StockDetail t0) -> isInRange(t0.getPosition10(), 0.3, 0.6)),
                new StrategyEnum("21154", "区间10_60_90", (StockDetail t0) -> isInRange(t0.getPosition10(), 0.6, 0.9)),
                new StrategyEnum("21156", "区间10_90_100", (StockDetail t0) -> isInRange(t0.getPosition10(), 0.9, 1.0)),
