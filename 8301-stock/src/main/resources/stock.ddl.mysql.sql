...
(
    ...
    next5_min_price_pert     decimal(10, 4) COMMENT '当天到5天内最低的涨幅(回调)',
    next10_min_price_pert    decimal(10, 4) COMMENT '当天到10天内最低的涨幅(回调)',
    ...
    rsi                      decimal(10, 5) comment 'RSI相对强弱指标(14日)',
    atr14                    decimal(10, 5) comment 'ATR平均真实波幅(14日)',
