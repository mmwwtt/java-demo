...
(
    ...
    rise20                   decimal(10, 4) COMMENT '当天收盘到20天后的涨幅',
    rise20_max               decimal(10, 4) COMMENT '当天收盘到20天内最高的涨幅',
    rise20_min               decimal(10, 4) COMMENT '当天收盘到20天内最低的涨幅(回调)',
...
(
    ...
    rise3_min_middle  DECIMAL(8, 4) COMMENT '4日最大中位数跌幅',
    ...
    rise5_min_middle  DECIMAL(8, 4) COMMENT '5日最大中位数跌幅',
    rise10_middle     DECIMAL(8, 4) COMMENT '10日中位数涨幅',
    rise10_max_middle DECIMAL(8, 4) COMMENT '10日最大中位数涨幅',
    rise10_min_middle DECIMAL(8, 4) COMMENT '10日最大中位数跌幅',
...
(
    ...
    rise3_min_middle      DECIMAL(8, 4) COMMENT '3日最大中位数跌幅',
    rise4_middle          DECIMAL(8, 4) COMMENT '4日中位数涨幅',
    rise5_middle          DECIMAL(8, 4) COMMENT '5日中位数涨幅',
    rise5_max_middle      DECIMAL(8, 4) COMMENT '5日最大中位数涨幅',
    rise5_min_middle      DECIMAL(8, 4) COMMENT '5日最大中位数跌幅',
